...
---@field LagCompensatedBody Barotrauma.PhysicsBody
---`Getter Public Instance`
---@field MemState (System.Collections.Generic.Queue*1Barotrauma*PosInfo)|(fun():(Barotrauma.PosInfo))
---`Getter Public Instance`
---<br/>`Setter Private Instance`
...
_G['Limb'].SetLagCompensatedBodyPositions = function(client) end
