...
---@return (System.Linq.IOrderedEnumerable*1Barotrauma*OrderPrefab)|(fun():(Barotrauma.OrderPrefab))
_G['PrefabCollection*1Barotrauma*OrderPrefab'].GetOrdered = function() end
