...
---`Field Public Static`
---@field MaxFireSources System.Int32
...
_G['Hull'].ForceStatusUpdate = function() end

---`Method Public Instance`
_G['Hull'].CreateStatusEvent = function() end
...
---@param includeHiddenHulls? System.Boolean
_G['Hull'].GetLinkedHulls = function(linkedHulls, includeHiddenHulls) end
...
---@overload fun(rectangle:Microsoft.Xna.Framework.Rectangle, submarine:Barotrauma.Submarine, id?:System.UInt16):Barotrauma.Hull
---@return Barotrauma.Hull
_G['Hull'] = function() end

---`Constructor Public Instance`
---@overload fun(rectangle:Microsoft.Xna.Framework.Rectangle):Barotrauma.Hull
---@overload fun(rectangle:Microsoft.Xna.Framework.Rectangle, submarine:Barotrauma.Submarine, id?:System.UInt16):Barotrauma.Hull
---@return Barotrauma.Hull
_G['Hull'].__new = function() end
