...
---`Field Private Static`
---@field ShadowVertices (System.Collections.Generic.List*1Microsoft*Xna*Framework*Graphics*VertexPositionColor)|(Microsoft.Xna.Framework.Graphics.VertexPositionColor[])
---`Field Private Static`
---@field PenumbraVertices (System.Collections.Generic.List*1Microsoft*Xna*Framework*Graphics*VertexPositionTexture)|(Microsoft.Xna.Framework.Graphics.VertexPositionTexture[])
---`Field Private Static`
