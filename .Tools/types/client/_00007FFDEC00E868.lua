...
---`Method Private Static`
---@param savedDeviceName System.String
---@param deviceType System.Int32
---@return System.Boolean
_G['SettingsMenu'].IsCurrentDevice = function(savedDeviceName, deviceType) end

---`Method Private Static`
---@return System.Boolean
_G['SettingsMenu'].CurrentDeviceMismatchesDisplayed = function() end

---`Method Public Instance`
---@param refresh? System.Boolean
_G['SettingsMenu'].CreateAudioAndVCTab = function(refresh) end
