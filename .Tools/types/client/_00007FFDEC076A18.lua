...
---@return (System.Linq.IOrderedEnumerable*1Barotrauma*SoundPrefab)|(fun():(Barotrauma.SoundPrefab))
_G['PrefabCollection*1Barotrauma*SoundPrefab'].GetOrdered = function() end
