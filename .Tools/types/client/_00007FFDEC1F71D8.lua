...
---@field rotateToolToggle Barotrauma.GUITickBox
---`Field Private Instance`
---@field scaleToolToggle Barotrauma.GUITickBox
---`Field Private Instance`
---@field oldWidgetWorldPos Microsoft.Xna.Framework.Vector2
---`Field Private Instance`
---@field transformCommand Barotrauma.TransformToolCommand
---`Field Private Instance`
---@field transformWidget Barotrauma.Widget
---`Field Private Instance`
...
---`Field Private Static`
---@field TransformWidgetOffset System.Single
---`Field Private Static`
...
---@field TransformWidgetSelected System.Boolean
...
_G['SubEditorScreen'].GetSelectionCenter = function() end
...
---@return Barotrauma.ExtraSubmarineInfo
_G['SubEditorScreen'].GetExtraSubmarineInfo = function(subInfo) end
...
---@param text System.String
---@return System.Boolean
_G['SubEditorScreen'].ChangeMissionTags = function(textBox, text) end

---`Method Private Static`
---@param parent Barotrauma.GUIComponent
---@param missionTags (System.Collections.Generic.IEnumerable*1Barotrauma*Identifier)|(fun():(Barotrauma.Identifier))
---@param onEnterPressed (Barotrauma.GUITextBox.OnEnterHandler)|(fun(textBox:Barotrauma.GUITextBox, text:System.String):(System.Boolean))
---@return Barotrauma.GUITextBox
_G['SubEditorScreen'].CreateMissionTagsUI = function(parent, missionTags, onEnterPressed) end
