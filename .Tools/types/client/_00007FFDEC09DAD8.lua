...
---@overload fun(parent:Barotrauma.Hull, prefab:Barotrauma.BallastFloraPrefab, offset:Microsoft.Xna.Framework.Vector2, firstGrowth?:System.Boolean):Barotrauma.MapCreatures.Behavior.BallastFloraBehavior
---@return Barotrauma.MapCreatures.Behavior.BallastFloraBehavior
_G['BallastFloraBehavior'] = function() end

---`Constructor Public Instance`
---@overload fun(parent:Barotrauma.Hull, prefab:Barotrauma.BallastFloraPrefab, offset:Microsoft.Xna.Framework.Vector2, firstGrowth?:System.Boolean):Barotrauma.MapCreatures.Behavior.BallastFloraBehavior
---@return Barotrauma.MapCreatures.Behavior.BallastFloraBehavior
_G['BallastFloraBehavior'].__new = function() end
