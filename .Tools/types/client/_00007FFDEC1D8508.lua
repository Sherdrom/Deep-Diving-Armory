...
---@param refreshUpgrades? System.Boolean
_G['UpgradeStore'].RequestRefresh = function(refreshUpgrades) end
...
---@overload fun(category:Barotrauma.UpgradeCategory, subItems?:(System.Collections.Generic.List*1Barotrauma*Item)|(Barotrauma.Item[])):(System.Boolean)
---@param category Barotrauma.UpgradeCategory
---@param item Barotrauma.Item
---@return System.Boolean
_G['UpgradeStore'].HasSwappableItems = function(category, item) end
