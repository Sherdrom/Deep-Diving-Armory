...
---@return (System.Linq.IOrderedEnumerable*1Barotrauma*CharacterPrefab)|(fun():(Barotrauma.CharacterPrefab))
_G['PrefabCollection*1Barotrauma*CharacterPrefab'].GetOrdered = function() end
