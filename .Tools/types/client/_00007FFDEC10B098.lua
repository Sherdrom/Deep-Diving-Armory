...
---@field guiContent Barotrauma.GUIComponent
...
---`Field NonPublic Instance`
---@field powerDisplay Barotrauma.GUITextBlock
---`Field NonPublic Instance`
---@field loadDisplay Barotrauma.GUITextBlock
---`Field NonPublic Instance`
...
_G['Components']['PowerTransfer'].CreateGUI = function() end

---`Method NonPublic Instance`
---@param parent Barotrauma.GUIComponent
_G['Components']['PowerTransfer'].CreateDefaultPowerUI = function(parent) end
