...
---@return (System.Linq.IOrderedEnumerable*1Barotrauma*BackgroundMusic)|(fun():(Barotrauma.BackgroundMusic))
_G['PrefabCollection*1Barotrauma*BackgroundMusic'].GetOrdered = function() end
