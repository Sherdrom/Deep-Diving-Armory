...
---@return (System.Linq.IOrderedEnumerable*1Barotrauma*ItemPrefab)|(fun():(Barotrauma.ItemPrefab))
_G['PrefabCollection*1Barotrauma*ItemPrefab'].GetOrdered = function() end
