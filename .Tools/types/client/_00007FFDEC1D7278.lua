...
---@param faction Barotrauma.Identifier
---@return System.Single
_G['Store'].GetReputationRequirement = function(priceInfo, faction) end

---`Method Private Static`
---@param priceInfo Barotrauma.PriceInfo
---@param faction Barotrauma.Identifier
---@return System.Boolean
_G['Store'].ReputationRequirementsMet = function(priceInfo, faction) end
