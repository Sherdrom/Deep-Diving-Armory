...
---@return (System.Linq.IOrderedEnumerable*1Barotrauma*DamageSound)|(fun():(Barotrauma.DamageSound))
_G['PrefabCollection*1Barotrauma*DamageSound'].GetOrdered = function() end
