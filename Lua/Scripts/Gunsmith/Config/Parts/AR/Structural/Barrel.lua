...
parts.AR_barrel_145 = { type = "barrel",
...
parts.hk416_barrel_std = { type = "barrel",
    ...
    mounts = { { path = "muzzle_mount", nameKey = "deep.gunsmith.mount.hk416_barrel_std.muzzle_mount", accepts = { "muzzle_mount" }, anchor = { x = 220, y = 1 } },
    }
}
