...
parts.deep_viper_pdw_stock = {
    ...
    stats = { Ergonomics = 75, RangedSpreadReduction = -0.2, MovementSpeed = 0.3 },
    visual = { texture = texture,
...
parts.deep_ums_arey_stock = {
    ...
    stats = { Ergonomics = 50, RangedSpreadReduction = 0.15, MovementSpeed = 0.05 },
    visual = { texture = texture,
...
parts.deep_ums_areb_stock = {
    ...
    stats = { Ergonomics = 50, MovementSpeed = 0.2 },
    visual = { texture = texture,
...
parts.deep_ace_socom_gen4_stock = {
    ...
    stats = { Ergonomics = 45, WeaponsSkillBonus = 40 , WeaponsSkillGainSpeed = 0.5 },
    visual = { texture = texture,
...
parts.deep_m7a1_stock = {
    ...
    stats = { Ergonomics = 70, RangedSpreadReduction = -0.2, MovementSpeed = 0.25 },
    visual = { texture = texture,
...
parts.deep_ravage_b_stock = {
    ...
    stats = { Ergonomics = 55, RangedSpreadReduction = 0.25 , WeaponsSkillBonus = -10 },
    visual = { texture = texture,
...
parts.deep_ravage_r_stock = {
    ...
    stats = { Ergonomics = 55, RangedSpreadReduction = 0.2 , MovementSpeed = 0.05 },
    visual = { texture = texture,
...
parts.deep_f93_pro_stock = {
    ...
    stats = { Ergonomics = 60, RangedSpreadReduction = 0.2 },
    visual = { texture = texture,
...
parts.deep_ubr_gen2_b_stock = {
    ...
    stats = { Ergonomics = 25, WeaponsSkillBonus = 25, WeaponsSkillGainSpeed = 0.4 },
    visual = { texture = texture,
...
parts.deep_ubr_gen2_fde_stock = {
    ...
    stats = { Ergonomics = 35, WeaponsSkillBonus = 15, WeaponsSkillGainSpeed = 0.25},
    visual = { texture = texture,
