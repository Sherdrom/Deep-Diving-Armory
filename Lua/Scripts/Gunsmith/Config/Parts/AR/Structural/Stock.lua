...
parts.deep_m4ss_stock = { type = "stock",
    ...
    stats = { Ergonomics = 30, RangedSpreadReduction = 0.15 ,WeaponsSkillBonus = 10 },
    visual = { 
        texture = texture,
...
parts.deep_dde_black_stock = { type = "stock",
    ...
    stats = { Ergonomics = 40, RangedSpreadReduction = 0.3 },
    visual = { 
        texture = texture,
...
parts.deep_lmt_sopmod_stock = { type = "stock",
    ...
    stats = { Ergonomics = 15, RangedSpreadReduction = 0.25 , MovementSpeed = -0.1 },
    visual = { 
        texture = texture,
...
parts.deep_hk_e1_stock = { type = "stock",
    ...
    stats = { Ergonomics = 10, RangedSpreadReduction = 0.4 , MovementSpeed = -0.15 },
    visual = { 
        texture = texture,
...
parts.deep_ak12_stock = { type = "stock",
    ...
    stats = { Ergonomics = 30, RangedSpreadReduction = 0.2 },
    visual = { 
        texture = texture,
...
parts.deep_vltor_emod_stock = { type = "stock",
    ...
    stats = { Ergonomics = 5, RangedSpreadReduction = 0.4 , MovementSpeed = -0.15, WeaponsSkillBonus = -10 },
    visual = { 
        texture = texture,
...
parts.deep_ds150b_stock = { type = "stock",
    ...
    stats = { Ergonomics = 35, RangedSpreadReduction = 0.2 , WeaponsSkillBonus = 10 },
    visual = { 
        texture = texture,
...
parts.deep_gl_core_stock = { type = "stock",
    ...
    stats = { Ergonomics = 65, RangedSpreadReduction = -0.1 ,MovementSpeed = 0.2 },
    visual = { 
        texture = texture,
...
parts.deep_mft_bus_stock = { type = "stock",
    ...
    stats = { Ergonomics = 50, RangedSpreadReduction = 0.1 , MovementSpeed = 0.1 },
    visual = { 
        texture = texture,
...
parts.deep_colt_n1_stock = { type = "stock",
    ...
    stats = { Ergonomics = 55, RangedSpreadReduction = -0.1 , MovementSpeed = 0.12 },
    visual = { 
        texture = texture,
...
parts.deep_b5_systems_stock = { type = "stock",
    ...
    stats = { Ergonomics = 25, RangedSpreadReduction = 0.35 , MovementSpeed = -0.1 },
    visual = { 
        texture = texture,
...
parts.deep_tactical_sba3_stock = { type = "stock",
    ...
    stats = { Ergonomics = 60, RangedSpreadReduction = -0.1 , MovementSpeed = 0.15 },
    visual = { 
        texture = texture,
...
parts.deep_prs_gen3_stock = { type = "stock",
    ...
    stats = { Ergonomics = 15, RangedSpreadReduction = 0.5 , MovementSpeed = -0.2 },
    visual = { 
        texture = texture,
...
parts.deep_acs_b_stock = { type = "stock",
    ...
    stats = { RangedSpreadReduction = 0.3, MovementSpeed = -0.15, WeaponsSkillBonus= -10 },
    visual = { 
        texture = texture,
...
parts.deep_gl_shock_stock = { type = "stock",
    ...
    stats = { Ergonomics = 20, RangedSpreadReduction = 0.3 , MovementSpeed = -0.1 },
    visual = { 
        texture = texture,
...
parts.deep_ds150_fde_stock = { type = "stock",
    ...
    stats = { Ergonomics = 35, RangedSpreadReduction = 0.25 },
    visual = { 
        texture = texture,
...
parts.deep_ctr_b_stock = { type = "stock",
    ...
    stats = { Ergonomics = 25, RangedSpreadReduction = 0.15 },
    visual = { 
        texture = texture,
...
parts.deep_moe_slk_stock = { type = "stock",
    ...
    stats = { Ergonomics = 45, MovementSpeed = 0.08 },
    visual = { 
        texture = texture,
...
parts.deep_acs_fde_stock = { type = "stock",
    ...
    stats = { Ergonomics = 10, RangedSpreadReduction = 0.2 , MovementSpeed = -0.1 },
    visual = { 
        texture = texture,
...
parts.deep_viper_mod1_stock = { type = "stock",
    ...
    stats = { Ergonomics = 55, RangedSpreadReduction = 0.15 ,MovementSpeed = 0.15 },
    visual = { 
        texture = texture,
...
parts.deep_dde_fde_stock = { type = "stock",
    ...
    stats = { Ergonomics = 40, RangedSpreadReduction = 0.25 ,WeaponsSkillBonus = 10 },
    visual = { 
        texture = texture,
...
parts.deep_hk_slim_line_stock = { type = "stock",
    ...
    stats = { Ergonomics = 40 , MovementSpeed = 0.05 },
    visual = { 
        texture = texture,
