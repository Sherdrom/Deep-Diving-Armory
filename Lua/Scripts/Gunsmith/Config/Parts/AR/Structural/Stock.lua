...
parts.deep_lmt_sopmod_stock = { type = "stock",
    ...
    stats = { Ergonomics = 15, RangedSpreadReduction = 0.3 , MovementSpeed = -0.1 },
    visual = { 
        texture = texture,
...
parts.deep_vltor_emod_stock = { type = "stock",
    ...
    stats = { Ergonomics = 5, RangedSpreadReduction = 0.4 , MovementSpeed = -0.2 },
    visual = { 
        texture = texture,
...
parts.deep_acs_b_stock = { type = "stock",
    ...
    stats = { RangedSpreadReduction = 0.3 , WalkingSpeed = -0.15 },
    visual = { 
        texture = texture,
...
parts.deep_moe_slk_stock = { type = "stock",
    ...
    stats = { Ergonomics = 45, RangedSpreadReduction = 0.05 , MovementSpeed = 0.1 },
    visual = { 
        texture = texture,
...
parts.deep_acs_fde_stock = { type = "stock",
    ...
    stats = { Ergonomics = 10, RangedSpreadReduction = 0.2 , WalkingSpeed = -0.1 },
    visual = { 
        texture = texture,
