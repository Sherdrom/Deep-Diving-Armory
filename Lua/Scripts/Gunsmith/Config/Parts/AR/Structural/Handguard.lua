...
parts.AR_handguard_std = { type = "handguard",
    ...
    mounts = { { path = "top_rail", accepts = { "picatinny_rail" }, anchor = { x = 39, y = 53 } },
...
parts.hk416_handguard_std = { type = "handguard",
    ...
    mounts = { { path = "Left_rail_mount", partType = "accessory_mount", nameKey = "deep.gunsmith.mount.hk416_handguard_std.Left_rail_mount", accepts = { "accessory" }, anchor = { x = 79, y = 0 } , visualOrder = 5},
