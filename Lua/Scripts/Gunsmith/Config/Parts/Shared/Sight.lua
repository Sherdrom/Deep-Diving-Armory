...
parts.deep_holo_sight = { type = "optic_mount",
    ...
    stats = { Ergonomics = 0, RangedSpreadReduction = 0.4, RangedAttackMultiplier = 0.1, WeaponsSkillBonus = 15, WalkingSpeed = 0.1 },
    visual = { 
...
parts.deep_red_dot = { type = "optic_mount",
    ...
    stats = { Ergonomics = 0, RangedSpreadReduction = 0.1, RangedAttackMultiplier = 0.20, WeaponsSkillBonus = 5, WalkingSpeed = 0.30 },
    visual = { 
        texture = sightTexture,
...
parts.deep_thermalgoggles_sight = { type = "optic_mount",
    ...
    stats = { Ergonomics = -5, RangedSpreadReduction = 0.30, WeaponsSkillBonus = -15 },
    visual = { 
        texture = sightTexture,
...
parts.deep_2x_sight = { type = "optic_mount",
    ...
    stats = { Ergonomics = -5, RangedSpreadReduction = 0.50, RangedAttackMultiplier = 0.10, WeaponsSkillBonus = 20, WalkingSpeed = 0.1 },
    visual = { 
        texture = sightTexture,
...
parts.deep_2x5x_sight = { type = "optic_mount",
    ...
    stats = { Ergonomics = -5, RangedSpreadReduction = 0.60, RangedAttackMultiplier = 0.05, WeaponsSkillBonus = 25, WalkingSpeed = 0.05 },
    visual = { 
        texture = sightTexture,
...
parts.deep_1_3x_sight = { type = "optic_mount",
    ...
    stats = { Ergonomics = -10, RangedSpreadReduction = 0.70, WeaponsSkillBonus = 25 },
    visual = { 
        texture = sightTexture,
...
parts.deep_1_6x_sight = { type = "optic_mount",
    ...
    stats = { Ergonomics = -15, RangedSpreadReduction = 0.80, WeaponsSkillBonus = 30, WalkingSpeed = -0.2 },
    visual = { 
        texture = sightTexture,
...
parts.deep_thermalgoggles_sight_6x = { type = "optic_mount",
    ...
    stats = { Ergonomics = -20, RangedSpreadReduction = 0.80, WeaponsSkillBonus = 20, WalkingSpeed = -0.30 },
    visual = { 
        texture = sightTexture,
...
parts.deep_8x_sight = { type = "optic_mount",
    ...
    stats = { Ergonomics = -25, RangedSpreadReduction = 0.90, RangedAttackMultiplier = 0.30, WeaponsSkillBonus = 30, WalkingSpeed = -0.3 },
    visual = { 
        texture = sightTexture,
