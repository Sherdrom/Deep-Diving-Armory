...
parts.focusingflashlight = { type = "accessory_mount",
    ...
    visual = { texture = accessoryTexture,
...
parts.spreadflashlight = { type = "accessory_mount",
...
parts.deep_laser = { type = "accessory_mount",
    nameKey = "deep.gunsmith.part.deep_laser",
    -- accessory 由护木的 optic_mount.accepts 决定。
    provides = { "accessory" },
    item = { identifier = "deep_laser" },
    stats = { Ergonomics = -1, RangedSpreadReduction = 0.03 },
    visual = { texture = laserTexture,
