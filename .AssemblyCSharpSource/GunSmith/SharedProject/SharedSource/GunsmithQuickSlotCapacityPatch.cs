namespace GunSmith
{
    ...
    public static class GunsmithQuickSlotCapacityPatch
    {
        ...
        public static void RegisterQuickSlotCapacity(string itemIdentifier, int maxSlot)
        {
        ...
        private static void InjectGunsmithQuickSubContainers(Item item, ContentXElement element)
        {
            ...
            string tags = gunsmithData?.GetAttributeString("quickslottags", "deep_gunsmith_part,deep_accessory,deep_sub_hanging,deep_muzzle_short,deep_muzzle_long") ?? string.Empty;
