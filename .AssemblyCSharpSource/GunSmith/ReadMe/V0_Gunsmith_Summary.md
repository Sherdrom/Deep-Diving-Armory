...
`GunSmith` is the first playable prototype of the new Deep-Diving-Armory gunsmith system.
...
- `.AssemblyCSharpSource/GunSmith/ClientProject/ClientSource/Plugin.cs`
  - client plugin entry only

- `.AssemblyCSharpSource/GunSmith/ClientProject/ClientSource/GunsmithApi.cs`
...
- `.AssemblyCSharpSource/GunSmith/ClientProject/ClientSource/GunsmithGui.cs`
  - dedicated Gunsmith window
  - button creation
  - button click -> Lua callback

- `.AssemblyCSharpSource/GunSmith/ClientProject/ClientSource/GunsmithComposer.cs`
  - layer spec parsing
  - texture composition
  - runtime sprite creation

- `.AssemblyCSharpSource/GunSmith/ClientProject/ClientSource/GunsmithState.cs`
  - internal data containers

- `.AssemblyCSharpSource/GunSmith/ClientProject/ClientSource/GunsmithSpritePatch.cs`
  - Harmony patches
